...
class Validate
{
     ...
     * @return $this
     */
    public function failException(bool $fail = true): Validate
    {
     ...
     * @return $this
     */
    public function remove($field, $rule = null): Validate
    {
        if (is_array($field)) {
     ...
     * @return bool
     */
    public function must($value): bool
    {
    ...
    public function is($value, string $rule, array $data = []): bool
    {
        switch (Str::camel($rule)) {
            ...
            case 'image':
                ...
                break;
            case 'token':
                $result = $this->token('__token__', $data);
                break;
            default:
     ...
     * @return bool
     */
    public function token(string $rule, array $data): bool
    {
